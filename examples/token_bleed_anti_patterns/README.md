...
Each file is a side-by-side prompt lab. Use synthetic Contoso.Retail scenarios only.
...
| 2 | [02_vendor_bundle_bloat/](02_vendor_bundle_bloat/) | Lockfiles, `dist/`, `node_modules` |
